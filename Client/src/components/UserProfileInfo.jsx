...
//               </p>
//             </div>
//             {/* Edit button when on profile page */}
//             {!profileId && (
//               <button
          ...
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            {profileId &&
              (isFollowing ? (
                ...
                <button
                  onClick={onFollow}
                  className="flex items-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer"
                >
